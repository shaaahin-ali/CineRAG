...
const MacOSDock: React.FC<MacOSDockProps> = ({
  ...
  const getResponsiveConfig = useCallback(() => {
    if (typeof window === 'undefined') {
      return { baseIconSize: 48, maxScale: 1.5, effectWidth: 200 };
    }
    ...
    return {
      baseIconSize: Math.max(52, Math.min(64, smallerDimension * 0.05)),
      maxScale: 1.7,
      effectWidth: 260,
    };
  }, []);
              ...
              {openApps.includes(app.id) && (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: '50%',
                    backgroundColor: 'rgba(253, 176, 34, 0.9)',
                    boxShadow: '0 0 6px rgba(253, 176, 34, 0.5)',
                  }}
                />
              )}
            </div>
