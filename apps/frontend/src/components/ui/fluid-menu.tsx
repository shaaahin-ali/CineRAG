  ...
  return (
    <div className="relative w-[64px]" data-expanded={isExpanded}>
      ...
      <div className="relative">
        ...
        <div 
          className="relative w-16 h-16 bg-[rgba(20,20,22,0.9)] backdrop-blur-md border border-white/10 cursor-pointer rounded-full group will-change-transform z-50 hover:border-gold-400/30 transition-colors"
        ...
        {childrenArray.slice(1).map((child, index) => (
          <div 
            key={index} 
            className="absolute top-0 left-0 w-16 h-16 bg-[rgba(20,20,22,0.9)] backdrop-blur-md border border-white/10 will-change-transform"
            style={{
